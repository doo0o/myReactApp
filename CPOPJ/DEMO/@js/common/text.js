...
function getSplitValue(tokenValue, delimiter, number){
    ...
    for(i=0;i<tokens.length;i++){
        if(i==new Function("return " + number)()){
...
String.prototype.isPhone = function() {
	...
	return new Function("return (/(02|0[3-9]{1}[0-9]{1})"+arg+"[1-9]{1}[0-9]{2,3}"+arg+"[0-9]{4}$/).test(this)")();
};
...
String.prototype.isMobile = function() {
	...
	var arg = argument[0] ? argument[0] : "";
	return new Function("return (/(01[016789])"+arg+"[1-9]{1}[0-9]{2,3}"+arg+"[0-9]{4}$/).test(this)")();
};
