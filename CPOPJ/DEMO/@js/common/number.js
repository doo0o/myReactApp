...
/**
 * <pre>
 * 입력값을 소숫점 n자릿수로 변환하여 toCurrency 함수를 호출한다.
 * </pre>
 * @param	amount	"1234567"
 * @param	decimal	2
 * @return	currencyString "1,234,567.00"
 */
function toCurrencyDecimal(amount, decimal){
	
	amount = (amount*1).toFixed(decimal);
...
function comma_call(id){
	...
	if(isNaN(filterNum(num))){
		alert(x2coMessage.getMessage("adminCommon.alert.MSG0003"));
		obj.value = "";
		return;
	}
	if(num == 0){
